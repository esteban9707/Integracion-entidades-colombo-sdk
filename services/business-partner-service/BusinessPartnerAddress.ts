...
import {
  ...
  BpAddrDepdntIntlLocNumberType
} from './BpAddrDepdntIntlLocNumber';
import {
  BpIntlAddressVersion,
  BpIntlAddressVersionType
} from './BpIntlAddressVersion';
import {
  AddressEmailAddress,
  ...
  implements BusinessPartnerAddressType<T>
{
   ...
   * @nullable
   */
  declare addressUuid?: DeserializedType<T, 'Edm.Guid'> | null;
  /**
   * Street 3.
   * Maximum length: 40.
   * @nullable
   ...
   * @nullable
   */
  declare countyCode?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * Township code for Township.
   * Maximum length: 8.
   * @nullable
   */
  declare townshipCode?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * Township.
   * Maximum length: 40.
   * @nullable
   */
  declare townshipName?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * One-to-many navigation property to the {@link BuPaAddressUsage} entity.
   */
  declare toAddressUsage: BuPaAddressUsage<T>[];
  /**
   * One-to-one navigation property to the {@link BpAddrDepdntIntlLocNumber} entity.
   */
  declare toBpAddrDepdntIntlLocNumber?: BpAddrDepdntIntlLocNumber<T> | null;
  /**
   * One-to-many navigation property to the {@link BpIntlAddressVersion} entity.
   */
  declare toBpIntlAddressVersion: BpIntlAddressVersion<T>[];
  /**
